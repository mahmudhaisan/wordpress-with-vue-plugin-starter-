...
mix
    .js('src/admin/admin.js', 'assets/js/admin.js').vue({ version: 3 })
    .js('src/frontend/frontend.js', 'assets/js/frontend.js')
    .sass('assets/sass/admin.scss', 'assets/css/admin.css');
